...
``` r
Go_results_up_graph <- Go_results_up_graph + scale_fill_gradientn(colours = palette.go(3)) #This will yield a white box as there were no significant results for the GO analysis
Go_results_up_graph #This will yield a white box as there were no significant results for the GO analysis
```
